            ...
            <ul class="flex lg:flex-row md:flex-row flex-col justify-center mx-auto lg:w-max md:w-max w-[100vw] h-full lg:gap-8 md:gap-4 gap-8 lg:text-[17px] md:text-md lg:p-0 md:p-0 p-6 font-light lg:bg-transparent md:bg-transparent bg-black lg:text-gray-500 md:text-black text-white">
                ...
                <div class="w-max h-full flex relative cursor-pointer" id="service" onmouseover="const serviceList = document.getElementById('serviceList'); serviceList.classList.remove('hidden')" onmouseleave=" const serviceList = document.getElementById('serviceList');serviceList.classList.add('hidden');">
                    ...
                    <ul id="serviceList" class=" absolute top-[100%] hidden  flex  flex-col left-0 lg:w-max md:w-max w-[90vw] h-max lg:gap-8 md:gap-4 gap-8 lg:text-[17px] bg-white shadow-lg shadow-gray-300 text-black p-4" >
                        <a href="{{route('services')}}" class="my-auto {{ isActiveRoute('services') }} hover:text-[#437158] hover:border-b-[2px] hover:border-b-[#437158] transition ease-in duration-200  "> <li>Services</li></a>
                        <a href="{{route('clients')}}" class="my-auto {{ isActiveRoute('clients') }} hover:text-[#437158] hover:border-b-[2px] hover:border-b-[#437158] transition ease-in duration-200  "> <li>Served companies</li></a>
                        <a href="{{route('services')}}" class="my-auto {{ isActiveRoute('services') }} hover:text-[#437158] hover:border-b-[2px] hover:border-b-[#437158] transition ease-in duration-200  "> <li>Organic herbs/essential oils</li></a>
                        <a href="{{route('services')}}" class="my-auto {{ isActiveRoute('services') }} hover:text-[#437158] hover:border-b-[2px] hover:border-b-[#437158] transition ease-in duration-200  "> <li>Plant installations</li></a>
                        <a href="{{route('services')}}" class="my-auto {{ isActiveRoute('services') }} hover:text-[#437158] hover:border-b-[2px] hover:border-b-[#437158] transition ease-in duration-200  "> <li>Documentations</li></a>
                        <a href="{{route('about')}}#clinicalTrial" class="my-auto {{ isActiveRoute('about') }} hover:text-[#437158] hover:border-b-[2px] hover:border-b-[#437158] transition ease-in duration-200  "> <li>Clinical trials</li></a>
                    </ul>
                </div>
                ...
                <a href="{{route('contact')}}" class="my-auto {{  isActiveRoute('contact')  }} hover:text-[#437158] hover:border-b-[2px] hover:border-b-[#437158] transition ease-in duration-200  lg:hidden md:hidden block "> <li>CONTACT-US</li></a>
