...
{{--    banner--}}
    <div class="w-full flex lg:flex-row md:flex-row flex-col">
        <div class="lg:w-[65%] md:w-[65%] w-[100%]">
            <div class="swiffy-slider slider-indicators-round">
                <ul class="slider-container ">
                    <li><img class="w-full  lg:h-[500px] md:h-[500px] sm:h-[500px] h-[400px]" src="{{asset('/assets/images/slider/1.jpg')}}"></li>
                    <li><img class="w-full  lg:h-[500px] md:h-[500px] sm:h-[500px] h-[400px]" src="{{asset('/assets/images/slider/2.jpg')}}"></li>
                    <li><img class="w-full  lg:h-[500px] md:h-[500px] sm:h-[500px] h-[400px]" src="{{asset('/assets/images/slider/3.jpg')}}"></li>
                    <li><img class="w-full  lg:h-[500px] md:h-[500px] sm:h-[500px] h-[400px]" src="{{asset('/assets/images/slider/4.jpg')}}"></li>
                    <li><img class="w-full  lg:h-[500px] md:h-[500px] sm:h-[500px] h-[400px]" src="{{asset('/assets/images/slider/5.jpg')}}"></li>
                    <li><img class="w-full  lg:h-[500px] md:h-[500px] sm:h-[500px] h-[400px]" src="{{asset('/assets/images/slider/6.jpg')}}"></li>
                    <li><img class="w-full  lg:h-[500px] md:h-[500px] sm:h-[500px] h-[400px]" src="{{asset('/assets/images/slider/7.jpg')}}"></li>
                    <li><img class="w-full  lg:h-[500px] md:h-[500px] sm:h-[500px] h-[400px]" src="{{asset('/assets/images/slider/8.jpg')}}"></li>
                    <li><img class="w-full  lg:h-[500px] md:h-[500px] sm:h-[500px] h-[400px]" src="{{asset('/assets/images/slider/9.jpg')}}"></li>
                    <li><img class="w-full  lg:h-[500px] md:h-[500px] sm:h-[500px] h-[400px]" src="{{asset('/assets/images/slider/10.jpg')}}"></li>
                </ul>
        ...
        <div class="lg:w-[35%] md:w-[35%] w-[100%] flex  flex-wrap">
            <div class="w-full flex">
                    <div class="w-[50%] lg:h-[250px] md:h-[250px] sm:h-[250px] h-[200px] bg-[#fa971c] overflow-hidden flex ">
                    ...
                    <div class="w-[50%] lg:h-[250px] md:h-[250px] sm:h-[250px] h-[200px]  bg-[#437158] overflow-hidden flex">
                        <div class="w-full h-full hover:h-[80%] hover:w-[80%] hover:m-auto flex hover:border-[2px] hover:border-white transition ease-in-out delay-150 duration-3000">
                            <div class="m-auto">
    ...
    <div class="xl:w-[70%] lg:w-[70%] md:w-[90%] w-[100%] mx-auto flex lg:flex-row md:flex-row flex-col gap-4 py-4 lg:px-8 md:px-6 ">
        <div class="h-96 lg:w-[35%] md:w-[35%] w-[100%] relative">
            ...
            <div class="text-[17.5px] font-semibold absolute -left-10 bottom-10 bg-white rounded-sm px-8 py-3 shadow-md shadow-gray-700">
                <span class="text-[#2f6246]" style="letter-spacing: 0.6px">Dr Vijay <span class="text-[#fa971c]">Kimteta</span></span>
            </div>
        </div>
        <div class="h-max bg:w-[65%] md:w-[65%] w-[100%] flex-col px-2 pl-4">
            ...
            <button class="bg-[#437158] px-8 py-3 h-max my-auto text-sm font rounded-sm text-white font-bold w-max mt-4 ">Read More</button>
        </div>
